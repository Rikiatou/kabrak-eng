    ...
    <footer className="bg-[#050a14] border-t border-blue-900/20 pt-16 pb-8">
      <div className="max-w-6xl mx-auto px-5">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-xs mb-5">
              Empowering African businesses through smart technology. We build digital solutions that work for Africa.
            </p>
          ...
          <div>
            ...
            >
              Démarrer un projet <ArrowRight className="w-3.5 h-3.5" />
            </Link>
          </div>
        </div>
        ...
        <div className="border-t border-slate-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-500">
          <span>© {year} KABRAK Engineering. Tous droits réservés.</span>
          <span className="flex items-center gap-1">
            Built in <span className="text-blue-400 font-medium">Africa</span> 🌍
          </span>
        </div>
      </div>
    </footer>
